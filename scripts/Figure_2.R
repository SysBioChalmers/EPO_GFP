...
# import samples table
  sam <- read.delim('./data/samples_for_correlation_analysis.txt')
  rownames(sam) <- sam[,1]
  sam <- sam[,2:17]
...
method = "spearman"
  ...
  ggsave('./results/',gene_name,'_epo.png',width = 10, height = 7, units="cm")
  ...
  ggsave('./results/',gene_name,'_gfp.png',width=10,height=7, units="cm")
